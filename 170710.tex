...
\item Utilized data mining techniques to troubleshoot experimental hardware problems
\item Wrote software using data science techniques to enable rapid experimental comparison from within sophisticated graphical user interface
...
\item Multiplexed OLED lifetime measurement setup to 14 simultaneous devices
