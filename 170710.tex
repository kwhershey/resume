...
Holmes Research Group \\ %\vspace{2ex}
...
\item Maintain code repository for testing and analysis software using Github, featuring over 13,000 lines of code
...
\begin{tabular}{ @{} >{\bfseries}l @{\hspace{3ex}} p{14.25cm} }
...
\item Defended Physics Club at annual student activities committee budget meeting and special budgetary meetings which succeeded in funding over 30 students to attend the 2012 Sigma Pi Sigma Quadrennial Congress
...
\item Organized and led weekly troop meetings and monthly campouts for a troop of over 30 boys aged 12-16
\end{rSubsection}
